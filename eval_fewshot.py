...
def parse_option():
    ...
    # meta setting
    parser.add_argument('--n_test_runs', type=int, default=6000, metavar='N',
...
def main():
    ...
    start = time.time()
    test_acc_feat, test_std_feat = meta_test(model, meta_testloader, use_logit=False, opt=opt)
    ...
    # start = time.time()
    # test_acc, test_std = meta_test(model, meta_testloader, opt=opt)
    # test_time = time.time() - start
    # print('test_acc: {:.4f}, test_std: {:.4f}, time: {:.1f}'.format(test_acc, test_std,
    #                                                                 test_time))

    # start = time.time()
    # val_acc_feat, val_std_feat = meta_test(model, meta_valloader, use_logit=False, opt=opt)
    # val_time = time.time() - start
    # print('val_acc_feat: {:.4f}, val_std: {:.4f}, time: {:.1f}'.format(val_acc_feat,
    #                                                                    val_std_feat,
    #                                                                    val_time))

    # val_acc, val_std = meta_test(model, meta_valloader, opt=opt)
    # val_time = time.time() - start
